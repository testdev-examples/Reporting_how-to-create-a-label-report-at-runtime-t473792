...
'ORIGINAL LINE: this.btnBuildReport.Click += new System.EventHandler(this.btnBuildReport_Click);
			' 
			' LabelWidthSpinEdit
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.UnitComboBox.SelectedIndexChanged += new System.EventHandler(this.UnitComboBox_SelectedIndexChanged);
			' 
			' layoutControlGroup1
			' 
